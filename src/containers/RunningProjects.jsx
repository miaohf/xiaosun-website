                ...
                <div className="row justify-content-between">
                    <div className="col-lg-5 col-md-5 col-sm-5">
                        <div className="left_part">
                            <div className="grid-item">
                                <RunningProjectItem img="images/image_box/3.jpg" name="XiaoSun" details="红木家居到艺术品转变的见证"></RunningProjectItem>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-5 col-md-5 col-sm-5">
                        <div className="right_part">
                            <div className="grid-item" >
                                <RunningProjectItem img="images/image_box/2.jpg" name="XiaoSun" details="红木家居到艺术品转变的见证"></RunningProjectItem>
                            </div>

                            <div className="grid-item active">
                                <RunningProjectItem img="images/image_box/1.jpg" name="XiaoSun" details="红木家居到艺术品转变的见证"></RunningProjectItem>
                            </div>
                        </div>
                    </div>
                </div>
