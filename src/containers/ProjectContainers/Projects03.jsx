        ...
        <section className="projects top-margin bg-transparent effect-tilt p-0">
            <div className="container">
                <div className="row gutter-90 clearfix mb-clearfix">
                    ...
                    <div className="grid-item col-12 col-lg-6 interiors">
                        <ProjectCard3_2 img="images/portfolio/7.jpg" details="红木家居到艺术品转变的见证"></ProjectCard3_2>
                    </div>
                    <div className="grid-item col-12 col-lg-6 residences">
                        <ProjectCard3_2 img="images/portfolio/8.jpg" details="Newyork golf XiaoSun"></ProjectCard3_2>
                    </div>
                    <div className="grid-item col-12 col-lg-6 exterior">
                        <ProjectCard3_2 img="images/portfolio/1.jpg" details="红木家居到艺术品转变的见证"></ProjectCard3_2>
                    </div>
                    <div className="grid-item col-12 col-lg-6 interiors">
                        <ProjectCard3_2 img="images/portfolio/2.jpg" details="红木家居到艺术品转变的见证"></ProjectCard3_2>
                    </div>
                    <div className="grid-item col-12 col-lg-6 residences">
                        <ProjectCard3_2 img="images/portfolio/3.jpg" details="红木家居到艺术品转变的见证"></ProjectCard3_2>
                    </div>
                    <div className="grid-item col-12 col-lg-6 landscape exterior">
