    ...
    return (
        <section className="project-list-view bg-dark-200">
            <div className="container">
                ...
                <div className="details_link"><a href="/project-details"><span className="link_text">详情</span> <span className="link_icon"><span className="line"></span> <span className="circle"></span><span className="dot"></span></span></a></div>
            </div>
        </section>
    );
};
