...
const SideNav = () => {
    return (
        <div className="mr_menu">
            ...
            <div className="logo_left_menu"><a href="/" className="light_logo"><img src="images/logo-circle.jpg" alt="logo" /></a></div>

            {/* MainMenu */}
            <ul className="main_menu">
                <li className="menu-item menu-item-has-children active"><a href="/">主页</a>
