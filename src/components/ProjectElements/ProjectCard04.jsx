        ...
        <div className="thumb">
            ...
            <div className="works-info">
                <div className="label-text">
                    <h6><a href="#">精细木作技艺</a></h6>
                    <h5><a href="/project-details-2">{props.details}</a></h5>
                    <div className="details_link"><a href="/project-details-2"><span className="link_text">详情</span> <span className="link_icon"><span className="line"></span> <span className="circle"><span className="dot"></span></span></span></a></div>
                </div>
            </div>
        </div>
