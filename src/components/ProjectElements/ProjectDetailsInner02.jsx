        ...
        <div className="project-details_inner">
            <div className="post_content">
                <div className="post-header">
                    <h3 className="post-title">传统木工手艺文化传承</h3>
                </div>
                <div className="fulltext">
                    <p>
                        让手艺拥抱科技, interior architecture, space planning and programming. Our portfolio of completed work includes highly acclaimed and award-winning projects for clients around the country.
                    </p>
                    ...
                    <ul className="point_order">
                        ...
                        <li>团队成员 members are some of the finest professionals in the industry.</li>
